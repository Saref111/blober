import{b as c,i as g}from"./assets/vendor-a8b16073.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerpolicy&&(r.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?r.credentials="include":n.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();const f=()=>{let e="#";for(let t=0;t<3;t++){let o=Math.floor(Math.random()*256).toString(16);e+=o.padStart(2,"0")}return e},u=(e,t)=>Math.floor(Math.random()*(t-e+1))+e,h=()=>Date.now().toString(36)+Math.random().toString(36).slice(2),p=()=>"translate",d=650,b=`<defs>
                    ...
                    filterUnits="userSpaceOnUse" col4or-interpolation-filters="sRGB">
                        ...
                        >
                            Hello, Blob!
                        </text>`,v=e=>{const t=c({size:d,growth:1,seed:e.seed.toString()}).path,o=[c({size:d,growth:1.5,seed:(e.seed+1).toString()}).path,c({size:d,growth:2,seed:(e.seed+2).toString()}).path];return`<g transform="${e.transform.type}(${e.transform.args.join(", ")})" filter="url(#${e.filterId})">
