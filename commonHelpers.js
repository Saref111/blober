import{b as d,i as v}from"./assets/vendor-a8b16073.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerpolicy&&(r.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?r.credentials="include":n.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();const h=()=>{let e="#";for(let t=0;t<3;t++){let s=Math.floor(Math.random()*256).toString(16);e+=s.padStart(2,"0")}return e},p=(e,t)=>Math.floor(Math.random()*(t-e+1))+e,b=()=>Date.now().toString(36)+Math.random().toString(36).slice(2),E=()=>"translate",u=650,S=`<defs>
            ...
            </g>`},x=(e,t)=>{const s=document.createElementNS("http://www.w3.org/2000/svg","svg");s.innerHTML=t;const o=s.querySelector("g");let n=e.transform.args[0],r=e.transform.args[1],i=0,l=0;const f=c=>{const m=c.clientX-n,g=c.clientY-r;i=m,l=g,o.setAttribute("transform",`translate(${m} ${g})`)};return o.addEventListener("mousedown",c=>{c.stopPropagation(),n=c.clientX-n,r=c.clientY-r,document.addEventListener("mousemove",f),document.addEventListener("mouseup",()=>{document.removeEventListener("mousemove",f),a.updateEntity(e,{...e,transform:{type:"translate",args:[i,l]}})})}),o},A=(e,t)=>{e.color||(e.color=h());const s=x(e,B(e));t.insertAdjacentElement("afterbegin",s)},y=e=>{const t=document.querySelector(".screen");if(!e.length){t.innerHTML=L;return}t.innerHTML="",t.insertAdjacentHTML("beforeend",S),e.forEach(s=>{A(s,t)})},$=()=>{const e=document.querySelector(".screen"),t=document.querySelector("#load-svg"),s=document.querySelector("#copy-svg");document.querySelector("#copy-svg-as-base64").addEventListener("click",()=>{const n=new XMLSerializer().serializeToString(e),r=v(n);navigator.clipboard.writeText(r)}),s.addEventListener("click",()=>{const n=new XMLSerializer().serializeToString(e);navigator.clipboard.writeText(n)}),t.addEventListener("click",()=>{const n=new XMLSerializer().serializeToString(e),r=new Blob([n],{type:"image/svg+xml"}),i=URL.createObjectURL(r),l=document.createElement("a");l.href=i,l.download="blobs.svg",l.click(),URL.revokeObjectURL(i)})},k=()=>{const e=Math.floor(Math.random()*1e9);return{id:b(),transform:{type:E(),args:[p(-300,300),p(-300,300)]},filterId:"filter",color:h(),seed:e}},T=e=>{const t=a.findEntity(s=>s.id===e);t&&a.removeEntity(t)},_=(e,t)=>{var r;e.preventDefault();const s=(r=e.dataTransfer)==null?void 0:r.getData("text/plain");if(s===t)return;const o=a.findEntity(i=>i.id===s),n=a.findEntity(i=>i.id===t);!o||!n||a.moveEntity(o,a.getEntities().indexOf(n))},M=({id:e,color:t,seed:s})=>{const o=document.createElement("fieldset");return o.setAttribute("id",`blob_${e}`),o.setAttribute("draggable","true"),o.setAttribute("style",`--color: ${t};`),o.classList.add("blob-fieldset"),o.innerHTML=`
        <label>
            <span>Color:</span>
